                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-center align-items-center mb-0 gap-2 ">
                            ...
                            <img src="img/star-enable.png" alt="" style="width: 30px;" class="img-fluid">
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class=" col-12 mt-3">
                                        <div class="card-body">
                                            ...
                                            <img src="img/star<?= $r['rating']; ?>.png" class="img-fluid mx-auto d-block" style="width: 50px;">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <img src="img/defaults.png" class="img-thumbnail" alt="">
                                        </div>
                                        <div class="col-sm-12">
